...
dependency 'cesnet/hadoop', '>= 3.1.0 < 4.0.0'
dependency 'cesnet/hbase', '< 2.0.0'
dependency 'cesnet/hive', '>= 0.13.0 < 1.0.0'
dependency 'cesnet/impala', '< 2.0.0'
dependency 'cesnet/oozie', '>= 0.12.0 < 2.0.0'
dependency 'cesnet/pig', '< 1.0.0'
dependency 'cesnet/spark', '>= 1.0.0 < 3.0.0'
dependency 'cesnet/zookeeper', '>= 1.0.0 < 2.0.0'
dependency 'puppetlabs/apt', '< 8.0.0'
dependency 'puppetlabs/mysql', '< 11.0.0'
